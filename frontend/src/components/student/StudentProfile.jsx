...
const extractLeetCodeUsername = (input) => {
  ...
  // If it looks like a LeetCode URL, extract the username from it
  if (str.includes("leetcode.com")) {
    try {
      const url = new URL(str.startsWith("http") ? str : `https://${str}`);
      const parts = url.pathname.split("/").filter(Boolean);
      // Handles both /u/username/ and /username/
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-dark-400 mt-1">
                Enter just your username or paste your full LeetCode profile URL – we'll extract the username automatically.
              </p>
            </div>
